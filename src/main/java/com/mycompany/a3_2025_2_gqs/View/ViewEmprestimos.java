...
public class ViewEmprestimos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font(FONT_SEGOE_UI_BLACK, 0, 12)); // NOI18N
        jLabel2.setText("Data Emprestimo");

        jLabel3.setFont(new java.awt.Font(FONT_SEGOE_UI_BLACK, 0, 12)); // NOI18N
        ...
        jRealizarEmprestimo.setFont(new java.awt.Font(FONT_SEGOE_UI_BLACK, 0, 12)); // NOI18N
        ...
        cancelarEmprestimo.setFont(new java.awt.Font(FONT_SEGOE_UI_BLACK, 0, 12)); // NOI18N
        ...
        jLabel1.setFont(new java.awt.Font(FONT_SEGOE_UI_BLACK, 2, 36)); // NOI18N
    ...
    private void jRealizarEmprestimoActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (boxAmigos == null || boxAmigos.equals("") || boxFerramentas == null || boxFerramentas.equals("")) {
            ...
            int idAmigo = com.mycompany.a3_2025_2_gqs.Util.Util.obtemNum(boxAmigos);
            int idFerramenta = com.mycompany.a3_2025_2_gqs.Util.Util.obtemNum(boxFerramentas);
            String dataDevolucao = DataDevolucao.getText();
            String dataEmprestimo = DataEmprestimo.getText();
            LocalDate dtDevolucao = com.mycompany.a3_2025_2_gqs.Util.Util.converterData(dataDevolucao);
            LocalDate dtEmprestimo = com.mycompany.a3_2025_2_gqs.Util.Util.converterData(dataEmprestimo);
