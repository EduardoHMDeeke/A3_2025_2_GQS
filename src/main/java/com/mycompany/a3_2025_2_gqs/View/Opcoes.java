...
public class Opcoes extends javax.swing.JFrame {
    ...
    private static final String SEGOE_UI_BLACK = "Segoe UI Black";
    ...
    private void initComponents() {
        ...
        b_sair.setFont(new java.awt.Font(SEGOE_UI_BLACK, Font.ITALIC, 12));
        ...
        jLabel1.setFont(new java.awt.Font(SEGOE_UI_BLACK, Font.ITALIC, 48));
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Opções");

        jButton1.setBackground(new java.awt.Color(8, 119, 197));
        jButton1.setFont(new java.awt.Font(SEGOE_UI_BLACK, Font.ITALIC, 12));
